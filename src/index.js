...
function calculator(number = 0) {
    ...
    calc.sum = function sumIt(...args) {
        return args.reduce(function (sum, current) {
            return sum + current;
        }, number);
    };
    calc.dif = function diffIt(...args) {
        return args.reduce(function (diff, current) {
            return diff - current;
        }, number);
    };
    calc.div = function divIt(...args) {
        return args.reduce(function (diff, current) {
            if (current === 0) {
